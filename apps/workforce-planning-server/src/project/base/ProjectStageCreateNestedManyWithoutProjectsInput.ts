...
@InputType()
class ProjectStageCreateNestedManyWithoutProjectsInput {
...
export { ProjectStageCreateNestedManyWithoutProjectsInput as ProjectStageCreateNestedManyWithoutProjectsInput };

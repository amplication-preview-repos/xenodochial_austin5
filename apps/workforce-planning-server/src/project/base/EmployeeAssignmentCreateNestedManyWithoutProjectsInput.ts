...
@InputType()
class EmployeeAssignmentCreateNestedManyWithoutProjectsInput {
...
export { EmployeeAssignmentCreateNestedManyWithoutProjectsInput as EmployeeAssignmentCreateNestedManyWithoutProjectsInput };

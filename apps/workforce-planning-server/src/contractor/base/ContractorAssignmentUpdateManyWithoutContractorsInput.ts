...
@InputType()
class ContractorAssignmentUpdateManyWithoutContractorsInput {
...
export { ContractorAssignmentUpdateManyWithoutContractorsInput as ContractorAssignmentUpdateManyWithoutContractorsInput };

...
class ContractorCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ContractorAssignmentCreateNestedManyWithoutContractorsInput,
  })
  @ValidateNested()
  @Type(() => ContractorAssignmentCreateNestedManyWithoutContractorsInput)
  @IsOptional()
  @Field(() => ContractorAssignmentCreateNestedManyWithoutContractorsInput, {
    nullable: true,
  })
...
export { ContractorCreateInput as ContractorCreateInput };

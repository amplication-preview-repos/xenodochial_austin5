...
@InputType()
class PositionRequirementCreateInput {
  @ApiProperty({
    required: false,
    type: () =>
      EmployeeAssignmentCreateNestedManyWithoutPositionRequirementsInput,
  })
  @ValidateNested()
  @Type(
    () => EmployeeAssignmentCreateNestedManyWithoutPositionRequirementsInput
...
export { PositionRequirementCreateInput as PositionRequirementCreateInput };

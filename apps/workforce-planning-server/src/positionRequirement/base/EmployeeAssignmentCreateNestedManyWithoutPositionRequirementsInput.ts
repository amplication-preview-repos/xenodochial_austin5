...
@InputType()
class EmployeeAssignmentCreateNestedManyWithoutPositionRequirementsInput {
...
export { EmployeeAssignmentCreateNestedManyWithoutPositionRequirementsInput as EmployeeAssignmentCreateNestedManyWithoutPositionRequirementsInput };
